...
export const metadata = {
  ...
  description:
    "Discover high-quality products and enjoy a seamless shopping experience at The Prime Store.",
  keywords: "ecommerce, online shopping, best products, quality items",
  openGraph: {
    title: "The Prime Store",
    description:
      "Discover high-quality products and enjoy a seamless shopping experience.",
    url:
      process.env.NEXT_PUBLIC_PRODUCT_APP_URL ||
  ...
  <div className="bg-gray-50 min-h-screen flex flex-col justify-between">
    <main className="flex-1 flex flex-col justify-center items-center py-12 px-6 md:px-12 text-center">
      <h1 className="text-4xl md:text-5xl font-bold text-black">
        Welcome to The{" "}
        <span className="text-yellow-400 font-semibold">Prime</span> Store
      </h1>
